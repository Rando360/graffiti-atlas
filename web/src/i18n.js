...
const STRINGS = {
  ...
  'filter.density': { fr: 'DENSITÉ', en: 'DENSITY', es: 'DENSIDAD', de: 'DICHTE', it: 'DENSITÀ' },
  'density.light': { fr: 'Légère', en: 'Light', es: 'Ligera', de: 'Gering', it: 'Leggera' },
  'density.medium': { fr: 'Moyenne', en: 'Medium', es: 'Media', de: 'Mittel', it: 'Media' },
  'density.heavy': { fr: 'Dense', en: 'Heavy', es: 'Densa', de: 'Dicht', it: 'Densa' },
  ...
  'mod.density': { fr: 'Densité', en: 'Density', es: 'Densidad', de: 'Dichte', it: 'Densità' },
  ...
  'header.report.data': {
    fr: 'Rapport', en: 'Report', es: 'Informe', de: 'Bericht', it: 'Rapporto',
  },
  'report.title': {
    fr: 'Rapport de la zone', en: 'Area report', es: 'Informe de la zona',
    de: 'Gebietsbericht', it: 'Rapporto dell’area',
  },
  'report.total': { fr: 'graffitis', en: 'graffiti', es: 'grafitis', de: 'Graffiti', it: 'graffiti' },
  'report.detected': { fr: 'détectés', en: 'detected', es: 'detectados', de: 'erfasst', it: 'rilevati' },
  'report.active': { fr: 'Actifs', en: 'Active', es: 'Activos', de: 'Aktiv', it: 'Attivi' },
  'report.cleaned': { fr: 'Effacés', en: 'Removed', es: 'Borrados', de: 'Entfernt', it: 'Rimossi' },
  'report.byType': { fr: 'Par type', en: 'By type', es: 'Por tipo', de: 'Nach Typ', it: 'Per tipo' },
  'report.bySurface': { fr: 'Par surface', en: 'By surface', es: 'Por superficie', de: 'Nach Oberfläche', it: 'Per superficie' },
  'report.byCity': { fr: 'Par ville', en: 'By city', es: 'Por ciudad', de: 'Nach Stadt', it: 'Per città' },
  'report.csv': { fr: 'Télécharger CSV', en: 'Download CSV', es: 'Descargar CSV', de: 'CSV herunterladen', it: 'Scarica CSV' },
  'report.viewNote': {
    fr: 'Rapport basé sur la zone visible de la carte.',
    en: 'Report based on the visible map area.',
    es: 'Informe basado en el área visible del mapa.',
    de: 'Bericht basiert auf dem sichtbaren Kartenausschnitt.',
    it: 'Rapporto basato sull’area visibile della mappa.',
  },
  'report.empty': {
    fr: 'Aucun graffiti dans cette zone. Déplacez la carte et réessayez.',
    en: 'No graffiti in this area. Move the map and try again.',
    es: 'No hay grafitis en esta zona. Mueva el mapa e inténtelo de nuevo.',
    de: 'Keine Graffiti in diesem Bereich. Karte verschieben und erneut versuchen.',
    it: 'Nessun graffito in quest’area. Sposta la mappa e riprova.',
  },
  'report.noArea': { fr: 'Zone non définie.', en: 'No area selected.', es: 'Zona no definida.', de: 'Kein Bereich ausgewählt.', it: 'Nessuna area selezionata.' },
  'report.err': { fr: 'Échec du chargement du rapport.', en: 'Failed to load the report.', es: 'Error al cargar el informe.', de: 'Bericht konnte nicht geladen werden.', it: 'Impossibile caricare il rapporto.' },
  'report.col.city': { fr: 'Ville', en: 'City', es: 'Ciudad', de: 'Stadt', it: 'Città' },
  'report.col.address': { fr: 'Adresse', en: 'Address', es: 'Dirección', de: 'Adresse', it: 'Indirizzo' },
  'report.col.type': { fr: 'Type', en: 'Type', es: 'Tipo', de: 'Typ', it: 'Tipo' },
  'report.col.surface': { fr: 'Surface', en: 'Surface', es: 'Superficie', de: 'Oberfläche', it: 'Superficie' },
  'report.col.date': { fr: 'Date', en: 'Date', es: 'Fecha', de: 'Datum', it: 'Data' },
  'report.col.status': { fr: 'État', en: 'Status', es: 'Estado', de: 'Status', it: 'Stato' },
  'upload.surface.label': {
    fr: 'Type de surface', en: 'Surface type', es: 'Tipo de superficie',
    de: 'Oberflächentyp', it: 'Tipo di superficie',
  },
  ...
  'mod.view.map': { fr: 'Carte', en: 'Map', es: 'Mapa', de: 'Karte', it: 'Mappa' },
  'mod.view.reclassify': { fr: 'Reclasser', en: 'Reclassify', es: 'Reclasificar', de: 'Neu einordnen', it: 'Riclassifica' },
  'mod.reclassify.count': { fr: 'approuvés', en: 'approved', es: 'aprobados', de: 'genehmigt', it: 'approvati' },
  'mod.reclassify.hint': { fr: 'Modifiez le type et la densité ; la mesure reste inchangée.', en: 'Edit type and density; the measurement is left unchanged.', es: 'Edita tipo y densidad; la medida no se modifica.', de: 'Typ und Dichte ändern; die Messung bleibt unverändert.', it: 'Modifica tipo e densità; la misura resta invariata.' },
  'mod.reclassify.save': { fr: 'Enregistrer', en: 'Save', es: 'Guardar', de: 'Speichern', it: 'Salva' },
  'mod.reclassify.delete': { fr: 'Supprimer la photo', en: 'Delete photo', es: 'Eliminar foto', de: 'Foto löschen', it: 'Elimina foto' },
  'mod.reclassify.confirmDelete': { fr: 'Supprimer définitivement cette photo ? Elle sera retirée de la carte.', en: 'Delete this photo permanently? It will be removed from the map.', es: '¿Eliminar esta foto permanentemente? Se quitará del mapa.', de: 'Dieses Foto endgültig löschen? Es wird von der Karte entfernt.', it: 'Eliminare definitivamente questa foto? Verrà rimossa dalla mappa.' },
  'mod.map.close': { fr: 'proches', en: 'close', es: 'cercanos', de: 'nah', it: 'vicini' },
  'mod.map.hint': { fr: 'Glissez un point sur un autre pour les regrouper au même lieu.', en: 'Drag a point onto another to merge them into one location.', es: 'Arrastra un punto sobre otro para unirlos en un lugar.', de: 'Ziehe einen Punkt auf einen anderen, um sie an einem Ort zusammenzuführen.', it: 'Trascina un punto su un altro per unirli in un unico luogo.' },
  'mod.map.dragTip': { fr: 'Glisser sur un point proche pour regrouper', en: 'Drag onto a nearby point to merge', es: 'Arrastra a un punto cercano para unir', de: 'Auf einen nahen Punkt ziehen zum Zusammenführen', it: 'Trascina su un punto vicino per unire' },
  'mod.map.confirmLink': { fr: 'Regrouper ces deux points au même lieu ? (rien n’est supprimé — historique conservé)', en: 'Merge these two points into one location? (nothing is deleted — history kept)', es: '¿Unir estos dos puntos en un lugar? (no se borra nada — se conserva el historial)', de: 'Diese zwei Punkte an einem Ort zusammenführen? (nichts wird gelöscht — Verlauf bleibt)', it: 'Unire questi due punti in un unico luogo? (niente viene eliminato — cronologia mantenuta)' },
  'mod.map.nokey': { fr: 'Clé Google Maps manquante.', en: 'Google Maps key missing.', es: 'Falta la clave de Google Maps.', de: 'Google-Maps-Schlüssel fehlt.', it: 'Chiave Google Maps mancante.' },
  'mod.map.compareHint': { fr: 'Cliquez un point pour voir la photo ; cliquez-en deux pour comparer.', en: 'Click a point to see its photo; click two to compare.', es: 'Haz clic en un punto para ver la foto; en dos para comparar.', de: 'Klicke einen Punkt für sein Foto; zwei zum Vergleichen.', it: 'Clicca un punto per la foto; due per confrontare.' },
  'mod.map.pick2': { fr: 'Choisissez un 2e point pour comparer.', en: 'Pick a 2nd point to compare.', es: 'Elige un 2º punto para comparar.', de: 'Wähle einen 2. Punkt zum Vergleichen.', it: 'Scegli un 2° punto per confrontare.' },
  'mod.map.apart': { fr: 'd’écart', en: 'apart', es: 'de distancia', de: 'entfernt', it: 'di distanza' },
  'map.viewmode': { fr: 'Affichage de la carte', en: 'Map display', es: 'Vista del mapa', de: 'Kartenansicht', it: 'Vista mappa' },
  'map.clusters': { fr: 'Groupes', en: 'Clusters', es: 'Grupos', de: 'Gruppen', it: 'Gruppi' },
  ...
  'mod.map.svHint': { fr: 'Cliquez un point pour voir Street View à cet endroit.', en: 'Click a point to see Street View at that spot.', es: 'Haz clic en un punto para ver Street View ahí.', de: 'Klicke einen Punkt für Street View an dieser Stelle.', it: 'Clicca un punto per vedere Street View lì.' },
  ...
  'mod.map.dupGroups': { fr: 'groupes de photos proches (cliquez pour localiser)', en: 'groups of close photos (click one to locate it)', es: 'grupos de fotos cercanas (haz clic para ubicar)', de: 'Gruppen naher Fotos (zum Finden anklicken)', it: 'gruppi di foto vicine (clicca per localizzare)' },
  'mod.map.dupGroupsShort': { fr: 'groupes', en: 'groups', es: 'grupos', de: 'Gruppen', it: 'gruppi' },
  'mod.map.dupsEmpty': { fr: 'Aucune photo trop proche à vérifier.', en: 'No too-close photos to review.', es: 'No hay fotos demasiado cercanas para revisar.', de: 'Keine zu nahen Fotos zu prüfen.', it: 'Nessuna foto troppo vicina da verificare.' },
  ...
  'mod.empty.bulk': {
    fr: 'Aucun scan en attente.',
    en: 'No scans awaiting review.',
    es: 'No hay escaneos pendientes.',
    de: 'Keine Scans zur Prüfung.',
    it: 'Nessuna scansione in attesa.',
  },
  'mod.bulk.pending': { fr: 'en attente', en: 'pending', es: 'pendientes', de: 'ausstehend', it: 'in attesa' },
  'mod.bulk.loadmore': { fr: 'Charger 100 de plus', en: 'Load 100 more', es: 'Cargar 100 más', de: '100 weitere laden', it: 'Carica altri 100' },
  'mod.bulk.refresh': { fr: 'Actualiser', en: 'Refresh', es: 'Actualizar', de: 'Aktualisieren', it: 'Aggiorna' },
  'mod.bulk.selected': { fr: 'sélectionné(s)', en: 'selected', es: 'seleccionado(s)', de: 'ausgewählt', it: 'selezionati' },
  ...
  'mod.bulk.confirmReject': {
    ...
    es: '¿Rechazar todas las filas seleccionadas? No se puede deshacer.',
  ...
  'surface.brick': { fr: 'Brique', en: 'Brick', es: 'Ladrillo', de: 'Ziegel', it: 'Mattone' },
  'surface.metal': { fr: 'Métal', en: 'Metal', es: 'Metal', de: 'Metall', it: 'Metallo' },
  'surface.glass': { fr: 'Verre', en: 'Glass', es: 'Vidrio', de: 'Glas', it: 'Vetro' },
  'surface.wood': { fr: 'Bois', en: 'Wood', es: 'Madera', de: 'Holz', it: 'Legno' },
  'surface.other': { fr: 'Autre', en: 'Other', es: 'Otro', de: 'Andere', it: 'Altro' },
  'upload.source.title': {
  ...
  'measure.title': {
    ...
    de: 'Graffiti messen', it: 'Misura il graffito',
  },
  'measure.step1': {
    fr: 'Étape 1 : tracez une ligne le long d\'un objet de référence (porte, personne…)',
    en: 'Step 1: draw a line along a reference object (door, person…)',
    es: 'Paso 1: traza una línea a lo largo de un objeto de referencia (puerta, persona…)',
    de: 'Schritt 1: Linie entlang eines Referenzobjekts ziehen (Tür, Person…)',
    it: 'Passo 1: traccia una linea lungo un oggetto di riferimento (porta, persona…)',
  },
  'measure.step2': {
    fr: 'Étape 2 : dessinez un rectangle autour du graffiti',
    en: 'Step 2: draw a rectangle around the graffiti',
    es: 'Paso 2: dibuja un rectángulo alrededor del grafiti',
    de: 'Schritt 2: Rechteck um das Graffiti zeichnen',
    it: 'Passo 2: disegna un rettangolo attorno al graffito',
  },
  'measure.done': {
    fr: 'Estimation calculée — ajustez ou validez',
    en: 'Estimate calculated — adjust or confirm',
    es: 'Estimación calculada — ajusta o confirma',
    de: 'Schätzung berechnet — anpassen oder bestätigen',
    it: 'Stima calcolata — regola o conferma',
  },
  ...
  'measure.mode.persp': { fr: 'Précis (mur en angle)', en: 'Precise (angled wall)', es: 'Preciso (muro en ángulo)', de: 'Präzise (schräge Wand)', it: 'Preciso (muro angolato)' },
  'measure.mode.line': { fr: 'Rapide (ligne)', en: 'Quick (line)', es: 'Rápido (línea)', de: 'Schnell (Linie)', it: 'Rapido (linea)' },
  'measure.persp.corners': { fr: 'Cliquez les 4 coins d’un repère : haut-gauche, haut-droite, bas-droite, bas-gauche.', en: 'Click the 4 corners of a reference: top-left, top-right, bottom-right, bottom-left.', es: 'Haz clic en las 4 esquinas de una referencia: sup-izq, sup-der, inf-der, inf-izq.', de: 'Klicke die 4 Ecken einer Referenz: oben-links, oben-rechts, unten-rechts, unten-links.', it: 'Clicca i 4 angoli di un riferimento: alto-sx, alto-dx, basso-dx, basso-sx.' },
  'measure.persp.dims': { fr: 'Indiquez la taille réelle du repère.', en: 'Enter the reference’s real size.', es: 'Introduce el tamaño real de la referencia.', de: 'Reale Größe der Referenz eingeben.', it: 'Inserisci la dimensione reale del riferimento.' },
  'measure.persp.area': { fr: 'Encadrez chaque graffiti (ajoutez-en plusieurs).', en: 'Box each graffiti (add as many as you need).', es: 'Encuadra cada grafiti (añade los que necesites).', de: 'Jedes Graffiti umrahmen (beliebig viele).', it: 'Inquadra ogni graffito (aggiungine quanti servono).' },
  'measure.persp.invalid': { fr: 'Repère trop petit ou mal placé — choisissez un repère plus grand, près du graffiti.', en: 'Reference too small or off-plane — pick a bigger reference near the graffiti.', es: 'Referencia demasiado pequeña o mal ubicada — elige una mayor cerca del grafiti.', de: 'Referenz zu klein oder außerhalb der Ebene — größere Referenz nahe dem Graffiti wählen.', it: 'Riferimento troppo piccolo o fuori piano — scegline uno più grande vicino al graffito.' },
  'measure.boxes': { fr: 'zone(s)', en: 'box(es)', es: 'zona(s)', de: 'Feld(er)', it: 'area/e' },
  'measure.undoBox': { fr: 'Annuler la dernière', en: 'Undo last box', es: 'Deshacer última', de: 'Letztes rückgängig', it: 'Annulla ultima' },
  'measure.shape.door': { fr: 'Porte', en: 'Door', es: 'Puerta', de: 'Tür', it: 'Porta' },
  'measure.shape.window': { fr: 'Fenêtre', en: 'Window', es: 'Ventana', de: 'Fenster', it: 'Finestra' },
  'measure.shape.garage': { fr: 'Porte de garage', en: 'Garage door', es: 'Puerta de garaje', de: 'Garagentor', it: 'Porta garage' },
  'measure.shape.plate': { fr: 'Plaque d’immat.', en: 'Licence plate', es: 'Matrícula', de: 'Kennzeichen', it: 'Targa' },
  'measure.shape.bricks': { fr: 'Briques', en: 'Bricks', es: 'Ladrillos', de: 'Ziegel', it: 'Mattoni' },
  'measure.shape.custom': { fr: 'Autre…', en: 'Other…', es: 'Otro…', de: 'Andere…', it: 'Altro…' },
  'measure.ref.width': { fr: 'largeur (m)', en: 'width (m)', es: 'ancho (m)', de: 'Breite (m)', it: 'largh. (m)' },
  'measure.ref.height': { fr: 'hauteur (m)', en: 'height (m)', es: 'alto (m)', de: 'Höhe (m)', it: 'alt. (m)' },
  'measure.bricks.cols': { fr: 'nb briques (largeur)', en: 'bricks across', es: 'ladrillos (ancho)', de: 'Ziegel (breit)', it: 'mattoni (largh.)' },
  'measure.bricks.rows': { fr: 'nb rangs (hauteur)', en: 'courses down', es: 'hiladas (alto)', de: 'Reihen (hoch)', it: 'file (alt.)' },
  'measure.hint.ref': {
    fr: 'Tracez la référence', en: 'Draw the reference', es: 'Traza la referencia',
    de: 'Referenz zeichnen', it: 'Traccia il riferimento',
  },
  'measure.hint.area': {
    fr: 'Encadrez le graffiti', en: 'Outline the graffiti', es: 'Encuadra el grafiti',
    de: 'Graffiti umrahmen', it: 'Inquadra il graffito',
  },
  'measure.redo': { fr: 'Recommencer', en: 'Start over', es: 'Reiniciar', de: 'Neu beginnen', it: 'Ricomincia' },
  'measure.use': {
    fr: 'Utiliser cette taille', en: 'Use this size', es: 'Usar este tamaño',
    de: 'Diese Größe verwenden', it: 'Usa questa dimensione',
  },
