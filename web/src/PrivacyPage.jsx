...
const CONTENT = {
  fr: {
    ...
    blocks: [
      ...
      { t: 'quote', html: "Note : le floutage des visages est automatique. Le floutage des plaques d'immatriculation repose actuellement sur la modération manuelle, mais pourrait être automatisé à l'avenir. La présente politique sera mise à jour si cette méthode évolue." },
      { t: 'h2', html: '9. Mineurs' },
  ...
  en: {
    ...
    blocks: [
      ...
      { t: 'quote', html: 'Note: face blurring is automatic. License plate blurring currently relies on manual moderation, but may be automated in the future. This policy will be updated if the method changes.' },
      { t: 'h2', html: '9. Minors' },
  ...
  es: {
    ...
    blocks: [
      ...
      { t: 'quote', html: 'Nota: el difuminado de rostros es automático. El difuminado de matrículas se basa actualmente en la moderación manual, pero podría automatizarse en el futuro. Esta política se actualizará si el método cambia.' },
      { t: 'h2', html: '9. Menores' },
  ...
  de: {
    ...
    blocks: [
      ...
      { t: 'quote', html: 'Hinweis: Das Unkenntlichmachen von Gesichtern erfolgt automatisch. Das Unkenntlichmachen von Nummernschildern beruht derzeit auf manueller Moderation, könnte jedoch künftig automatisiert werden. Diese Richtlinie wird aktualisiert, wenn sich die Methode ändert.' },
  ...
  it: {
    ...
    blocks: [
      ...
      { t: 'quote', html: 'Nota: la sfocatura dei volti è automatica. La sfocatura delle targhe si basa attualmente sulla moderazione manuale, ma potrebbe essere automatizzata in futuro. La presente informativa sarà aggiornata se il metodo cambia.' },
      { t: 'h2', html: '9. Minori' },
